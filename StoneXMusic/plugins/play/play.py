...
import config
from StoneXMusic import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
...
@app.on_callback_query(filters.regex("StoneymousAdmin") & ~BANNED_USERS)
async def Stoneymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(filters.regex("StoneyPlaylists") & ~BANNED_USERS)
@languageCB
