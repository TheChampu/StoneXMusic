...
async def init():
    ...
    LOGGER("StoneXMusic.plugins").info("Successfully Imported Modules...")
    await userbot.start()
    await Stoney.start()
    try:
        await Stoney.stream_call("https://te.legra.ph/file/29f784eb49d230ab62e9e.mp4")
    except NoActiveGroupCall:
        LOGGER("StoneXMusic").error(
            "Please turn on the videochat of your log group\channel.\n\nStopping Bot..."
        )
        exit()
    except:
        pass
    await Stoney.decorators()
    ...
    await app.stop()
    await userbot.stop()
    LOGGER("StoneXMusic").info("Stopping StoneX Music Bot...")
